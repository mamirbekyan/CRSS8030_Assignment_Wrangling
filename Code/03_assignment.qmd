...
distinct_import_countries <- summarize (imports_poultrydata, 
                                        distinct_countries = n_distinct(partner_desc)
)
...
```{r}
min_max_imports <- filter (imports_poultrydata,
